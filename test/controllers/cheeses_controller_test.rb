...
class CheesesControllerTest < ActionController::TestCase
  ...
  test "should create cheese" do
    assert_difference('Cheese.count') do
      post :create, cheese: { family: @cheese.family, name: @cheese.name, origin: @cheese.origin, style: @cheese.style }
    end
  ...
  test "should update cheese" do
    patch :update, id: @cheese, cheese: { family: @cheese.family, name: @cheese.name, origin: @cheese.origin, style: @cheese.style }
    assert_redirected_to cheese_path(assigns(:cheese))
  end
